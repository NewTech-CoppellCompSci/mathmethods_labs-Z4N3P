...
public class Lab02 {
	...
	public static void problem01() {
		...
		//shows user the max and min integer as inputed 
	...
	public static void problem02() {
		Scanner inKey = new Scanner(System.in);
		//asks user to enter cylinder radius 
		System.out.print("Enter Cylinder Radius: ");
		int rad = inKey.nextInt();
		//asks for user to enter cylinder height 
	...
	public static void problem04() {
		Scanner inKey = new Scanner(System.in);
		//asks user to enter value for A
		System.out.print("Enter A-Value: ");
		double A = inKey.nextDouble();
		//asks user to enter value for B
		System.out.print("Enter B-Value: ");
		double B = inKey.nextDouble();
		//asks user to enter value for C
